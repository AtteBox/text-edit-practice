    ...
    return (
      <div className="flex gap-4">
        <p
          className="text-sm"
          style={{
            color: getDangerColor((levelResults.germs ?? 0) / levelResults.levelTotalGerms),
          }}
        >
        ...
        <p
          className="text-sm"
          style={{
            color: getDangerColor(1 - (levelResults.animals ?? 0) / levelResults.levelTotalAnimals),
          }}
        >
        ...
        <p
          className="text-sm"
          style={{
            color: getDangerColor(Math.max(200 - levelResults.currentLevelPoints, 0) / 200),
          }}
        >
